...
Another proof of interest to us when dealing with functions is proofs regarding the inverse, particularly the composition of a function and its inverse.
